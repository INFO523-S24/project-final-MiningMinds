...
The ensemble learning approaches including XGBoost and RF are more accurate than KNN. In the next step, we train the stacking model with a logistic regression as the metalearner.
